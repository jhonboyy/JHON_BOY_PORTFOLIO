export const projects = [
  {
    ...
    images: [
      { src: '/images/jhon-boy-illustration-lava-circular-drum.webp', alt: 'Illustration from the ‘Lava Circular’ brand identity project. A minimalistic drawing of a traditional drum with a checkered design and two large drumsticks resting on top.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-lava-circular-drum-artisan.webp', alt: 'Illustration from the ‘Lava Circular’ brand identity project. A black-and-white depiction of an artisan playing a large drum. The artisan, wearing a hat, is seated while holding drumsticks and striking the drum with an engaged posture.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-lava-circular-milkmaid.webp', alt: 'Illustration from the ‘Lava Circular’ brand identity project. A black-and-white depiction of a milkmaid in traditional clothing, leaning over a round milk press table, carefully working on the process.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-lava-circular-press-table.webp', alt: 'Illustration from the ‘Lava Circular’ brand identity project. A minimalistic black-and-white drawing of a press table with a circular design and crosshatched patterns, resting on three sturdy legs.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-lava-circular-bag.webp', alt: 'Illustration from the ‘Lava Circular’ brand identity project. A minimalistic black-and-white drawing of a woven drawstring bag with a checkered pattern and curved straps.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-lava-circular-loom-artisan.webp', alt: 'Illustration from the ‘Lava Circular’ brand identity project. A black-and-white depiction of an artisan seated at a loom, focused on weaving with their hands on the threads and feet operating the loom pedals.', width: 1080, height: 1080 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-cooker-with-a-bread-slice.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A cheerful baker character wearing a chef’s hat, holding a glowing slice of bread in one hand while leaping joyfully, conveying enthusiasm for baking.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-flour.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A playful depiction of a bag of flour with a plant icon, held by a baker, signifying the importance of quality ingredients.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-cooker-with-a-hat.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A baker character dressed in a white chef’s coat and light blue pants, holding a paper bag of flour in one hand and gesturing ‘okay’ with the other, representing precision and quality in baking.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-cooker-with-dough-on-its-face.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A baker character with a chef’s hat stretching dough over their face, symbolizing creativity and hands-on craftsmanship in baking.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-hands.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A close-up of hands holding a stretched piece of dough, showcasing the tactile experience central to bread-making.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-hydration.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A stylized mug filled with water, featuring water droplets on its surface, representing hydration as a key element in the baking process.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-dough.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A playful depiction of a bag of flour with a plant icon, held by a baker, signifying the importance of quality ingredients.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-bakken-&-baeck-flourly-levain.webp', alt: 'Illustration for the ‘Flourly’ app project by Bakken & Bæck. A minimalist representation of a starter dough (levain), highlighting the fundamental role of fermentation in bread-making.', width: 1080, height: 1080 },
  ...
  },
  {
    ...
    images: [
      { src: '/images/jhon-boy-illustration-red-cross-tenerife-mural-aids-1000-by-750.webp', alt: 'A vibrant mural on a street wall showcasing a cartoonish red creature being tackled by groups of people in white with dynamic expressions, holding signs and objects to subdue it. The central text reads ‘NO VIH,’ symbolizing a message against HIV/AIDS. The mural is signed ‘Jhon Boy Cruz Roja Nuestros Libres 2020’ and is accompanied by urban street elements.', width: 1000, height: 750 },
      { src: '/images/jhon-boy-illustration-red-cross-tenerife-mural-aids-2-1000-by-750.webp', alt: 'A wide view of a colorful mural located on a street corner, illustrating a red cartoonish creature subdued by people in white with a clear message in bold ‘NO VIH,’ advocating against HIV/AIDS. Additional urban elements such as signs and adjacent artworks can be seen in the surrounding context', width: 1000, height: 750 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      { src: '/images/jhon-boy-illustration-ace-&-tate-characters-in-a-chair.webp', alt: 'Four stylized characters surrounding one sitting on a red chair, actively interacting and handing over glasses. The background is bright yellow. This illustration is part of Ace & Tate’s winter campaign illustrated by Jhon Boy.', width: 3000, height: 3000 },
      { src: '/images/jhon-boy-illustration-ace-&-tate-persons-destroying-a-canvas.webp', alt: 'Four stylized characters animatedly holding a bright yellow canvas featuring abstract designs. They interact energetically against a dark green background. This is part of Ace & Tate’s winter campaign illustrated by Jhon Boy.', width: 3000, height: 3000 },
      { src: '/images/jhon-boy-illustration-ace-&-tate-persons-in-a-scarf.webp', alt: 'A group of four stylized characters huddled together, sharing a long red scarf, smiling and waving on a lavender background. This is part of Ace & Tate’s winter campaign illustrated by Jhon Boy.', width: 3000, height: 3000 },
      { src: '/images/jhon-boy-illustration-ace-&-tate-a-person-carrying-stuff-walking.webp', alt: 'A single stylized character dressed in a dark green coat, holding a turkey and a bottle, walking briskly, while a can rolls nearby on a beige background. Part of Ace & Tate’s winter campaign illustrated by Jhon Boy.', width: 3000, height: 3000 },
      { src: '/images/jhon-boy-illustration-ace-&-tate-persons-helping-to-take-off-a-sweater.webp', alt: 'Three stylized characters against an orange background, part of Ace & Tate’s winter campaign illustrated by Jhon Boy. Two are helping another character remove a large yellow sweater, creating a playful dynamic.', width: 3000, height: 3000 },
      { src: '/images/jhon-boy-illustration-ace-&-tate-persons-with-a-voucher.webp', alt: 'Three stylized characters in pastel and vibrant tones on a yellow background, part of Ace & Tate’s winter campaign illustrated by Jhon Boy. One character is lifting a voucher labeled “&” while the other two reach up to grab it.', width: 3000, height: 3000 },
      { src: '/images/jhon-boy-illustration-ace-&-tate-persons-enjoying-coffee.webp', alt: 'Three stylized characters enjoying hot beverages. One is wearing a Santa hat, while another character crouches playfully on the dark green background. Part of Ace & Tate’s winter campaign illustrated by Jhon Boy.', width: 3000, height: 3000 },
      { src: '/images/jhon-boy-illustration-ace-&-tate-person-in-the-sofa-christmas.webp', alt: 'A stylized character lounging upside down in a yellow outfit on a white sofa next to a white Christmas tree with gifts beneath. The beige background adds warmth. Part of Ace & Tate’s winter campaign illustrated by Jhon Boy.', width: 3000, height: 3000 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      { src: '/images/jhon-boy-illustration-persons-in-the-metro.webp', alt: 'A stylized illustration by Jhon Boy depicting five characters near a metro train in dynamic poses, all engaged in an amusing scene of stealing each other’s wallets. The characters, dressed in yellow shirts, blue pants, and red shoes, create a chaotic yet playful atmosphere. The metro train windows and doors in the gray background set the urban scene.', width: 1000, height: 1000 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      { src: '/images/jhon-boy-illustration-hotel-entrance-stairs.webp', alt: 'A minimalist illustration by jhon boy of a curved staircase leading upward, with a sign indicating “Rooms” in black text on a yellow background, against pale pink walls.', width: 1080, height: 1080 },
      ...
      { src: '/images/jhon-boy-illustration-person-opening-envelope.webp', alt: 'A close-up illustration by jhon boy of hands wearing green sleeves holding a yellow envelope, with a white card displaying the number “087 - 986” being removed, set against a pale pink background.', width: 1080, height: 1080 },
      { src: '/images/jhon-boy-illustration-telephone.webp', alt: 'A retro-style illustration by jhon boy of an intercom or telephone device with four large yellow buttons labeled “1,” “2,” “3,” and “4,” featuring coiled wires and a soft pink and yellow color palette.', width: 1080, height: 1080 },
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/images/jhon-boy-illustration-ramen.webp', alt: 'A poster illustration by Jhon Boy depicting a person enjoying a bowl of ramen. The character’s hands are holding chopsticks and a bowl filled with ramen noodles, egg, and toppings. Additional bowls with steaming soup, mushrooms, and other ingredients surround the main bowl on a table. The artwork is rendered in a monochromatic yellow palette with a minimalist, clean design.', width: 1080, height: 1080 },
    ],
    captions: {
      left: 'Ramen for one 🍜',
      right: 'NOV.07.2022',
