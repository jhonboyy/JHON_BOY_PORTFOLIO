  ...
  const projects = [
    {
      ...
      animations: [],
      images: [
        { src: './images/jhon-boy-illustration-lava-circular-drum.svg', alt: '' },
        { src: './images/jhon-boy-illustration-lava-circular-drum-artisan.svg', alt: '' },
        { src: './images/jhon-boy-illustration-lava-circular-milkmaid.svg', alt: '' },
        { src: './images/jhon-boy-illustration-lava-circular-press-table.svg', alt: '' },
        { src: './images/jhon-boy-illustration-lava-circular-bag.svg', alt: '' },
        { src: './images/jhon-boy-illustration-lava-circular-loom-artisan.svg', alt: '' },
      ],
      captions: {
    ...
    },
    {
      ...
      animations: [],
      images: [
        { src: './images/jhon-boy-illustration-desk-smoke-1.svg', alt: 'closeup of a hand nailing with a hammer' },
        { src: './images/jhon-boy-illustration-desk-smoke-2.svg', alt: 'closeup of a hand nailing with a hammer' },
        { src: './images/jhon-boy-illustration-desk-smoke-3.svg', alt: 'closeup of a hand nailing with a hammer' },
        { src: './images/jhon-boy-illustration-desk-smoke-4.svg', alt: 'closeup of a hand nailing with a hammer' }
      ],
      captions: {
    ...
    },
    {
      ...
      animations: [],
      images: [
        { src: './images/jhon-boy-illustration-ramen.svg', alt: '' },
      ],
      captions: {
        left: 'Ramen for one 🍜',
        right: 'NOV.07.2022'
