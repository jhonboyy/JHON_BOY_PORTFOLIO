export const projects = [
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-lava-circular-milkmaid.svg', alt: 'Milkmaid illustration', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-lava-circular-press-table.svg', alt: 'Press table illustration', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-lava-circular-bag.svg', alt: 'Illustration of a bag', width: 1080, height: 1080 },
  ...
  },
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-person-hanging-a-photo.svg', alt: 'Closeup of a person hands hanging a photo in the wall', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-person-sitted-in-a-sofa.svg', alt: 'A room with two sofas and a person sitted in one of them', width: 1080, height: 1080 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-strike-a-match.svg', alt: 'Closeup of hands striking a match', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-a-cabin-refuge.svg', alt: 'A cabin from the outside', width: 1080, height: 1080 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-wix-playground-academy-persons-in-a-mine-2.svg', alt: 'Person holding a pick in a mine', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-wix-playground-academy-persons-helping.svg', alt: 'Persons helping others to get out of the mine', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-wix-playground-academy-persons-in-a-mine.svg', alt: 'Two persons working in a mine', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-wix-playground-academy-person-carrying-a-rock.svg', alt: 'Person carrying a rock in a mine', width: 1080, height: 1080 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-desk-smoke-3.svg', alt: 'Closeup of a hand nailing with a hammer', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-desk-smoke-4.svg', alt: 'Closeup of a hand nailing with a hammer', width: 1080, height: 1080 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-person-in-a-hole.svg', alt: 'Person jumping into a hole in another person\'s chest', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-person-being-shooted.svg', alt: 'A person being shot', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-person-shooted-lying-on-the-ground.svg', alt: 'A person lying on the ground after being shot', width: 1080, height: 1080 },
      { src: '../images/white.png', alt: 'Placeholder image', width: 1080, height: 1080 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-ace-&-tate-persons-in-a-scarf.svg', alt: 'A group of persons wearing a giant scarf', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-ace-&-tate-a-person-carrying-stuff-walking.svg', alt: 'Person walking and carrying stuff', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-ace-&-tate-persons-helping-to-take-off-a-sweater.svg', alt: 'Persons helping another person take off a sweater', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-ace-&-tate-persons-with-a-voucher.svg', alt: 'Persons holding a voucher', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-ace-&-tate-persons-enjoying-coffee.svg', alt: 'Person enjoying coffee with friends at Christmas', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-ace-&-tate-person-in-the-sofa-christmas.svg', alt: 'Person in a sofa enjoying a Christmas gift', width: 1080, height: 1080 },
    ],
    captions: {
  ...
  },
  {
    ...
    images: [
      ...
      { src: '../images/jhon-boy-illustration-person-opening-envelope.svg', alt: 'Closeup of hands opening an envelope', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-telephone.svg', alt: 'Telephone with four numbers', width: 1080, height: 1080 },
      { src: '../images/jhon-boy-illustration-hands-rustling-paper.svg', alt: 'Closeup of hands rustling a piece of paper', width: 1080, height: 1080 },
      { src: '../images/white.png', alt: 'Placeholder image', width: 1080, height: 1080 },
    ],
    captions: {
      left: 'The call 📞',
