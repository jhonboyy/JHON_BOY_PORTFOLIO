...
function showAbout (){
    ...
    <p>JHON BOY IS AN ARTIST FROM TENERIFE, CANARY ISLANDS.</p>
  ...
  <div class="about-column-2">
    ...
    <figure class="container-portrait">
      ...
      <img class="portrait-2" src="./images/jhon-boy-illustration-portrait-2.webp" alt="portrait photo of jhon boy">
    </figure>
    <p class="description">
